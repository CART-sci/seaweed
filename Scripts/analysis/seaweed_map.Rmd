...
big_map <- tm_shape(n_to_p_eez) +
  tm_raster(palette = "white", legend.show = F) + #i've only added this layer as white because it keeps the sw_lines from drawing a line across the map! Seriously remove these first two lines and its the same map but with a line across the whole thing
...
```{r}
##save
tmap_save(big_map, filename = "../../Figs/map.png", width = 12, height = 5)
tmap_save(big_map, filename = "../../Figs/map.pdf", width = 12, height = 5)
```
